let display = document.getElementById("display");
    ...
    function calculate() {
        ...
        HBD = (function(){
            if(today.getMonth() == dob.getMonth()) {
                if(today.getDate() == dob.getDate()) {
                    ...
                    alert('hey cutie its your birthday 🥳')
                }
                else {
                    disBD.innerHTML = "";
                }
        ...
        display.innerHTML = "Hi Dear i love you its your birthday " 
        
        +input[0].value + ", <br/>You are " + year + " Years, " + month +
        " Months, " + day + " Days, ";
        calTime = setInterval(duration, 1000).style='backgroundcolor=red'
        ;
    }
